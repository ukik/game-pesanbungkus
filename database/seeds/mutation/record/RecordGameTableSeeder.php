...
# php artisan db:seed --class=RecordGameTableSeeder

use App\Model\User\PostWallet;
use Illuminate\Database\Seeder;

class RecordGameTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $code_mission = DB::table('mutation_record_mission')->get();
            ...
            for ($i = 0; $i < count($code_mission); $i++) {
                ...
                DB::table('mutation_record_game')->insert(
                    [
                        ...
                        'code_mission' => $code_mission[$i]->uuid,
						'code_tools_vehicle' => $code_mission[$i]->code_tools_vehicle,
                        'title' => $code_mission[$i]->title,
                        'premium' => $code_mission[$i]->premium,
                        'normal' => $code_mission[$i]->normal,
