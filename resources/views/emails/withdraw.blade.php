...
@section('content')
	...
	@include('beautymail::templates.widgets.articleStart')
		<h2 style="font-family: calibri;" class="secondary"><strong>Data Penarikan</strong></h2>

		<h4 class="primary"><strong>Hi, Dear Gamer</strong></h4>
		<p style="font-family:arial; font-size:14px">Terimakasih sudah bergabung di <i>Game Pesanbungkus</i>, informasi ini adalah pemberitahuan tentang transaksi penarikan Cash & Coin: </p>
		...
		<br>
		<p style="font-family:arial; font-size:14px">Kami sedang melalukan proses validasi maksimal 2x24 jam, jika tidak ada kendala, maka uang kamu akan masuk ke saldo PB-Pay</p> 
