...
class JWTAuth
{
    ...
    // UBAH SESUAI DENGAN HEADER JWT YANG DIPASANG
    // KALAU TIDAK PASTI ERROR    
    public function parseToken($method = 'bearer', $header = 'Proxy-Authorization', $query = 'token')
    {
    ...
    // UBAH SESUAI DENGAN HEADER JWT YANG DIPASANG
    // KALAU TIDAK PASTI ERROR
    protected function parseAuthHeader($header = 'Proxy-Authorization', $method = 'bearer')
    {
